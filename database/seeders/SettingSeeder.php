 ...
 *
 * Uses firstOrCreate so re-running this seeder won't overwrite
 * values that the admin has already customised via the UI.
 */
class SettingSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            ...
            ['key' => 'support_email',   'value' => '',          'label' => 'Support Email',      'group' => 'general'],

            // ── Community ─────────────────────────────────────────────────────
            ['key' => 'community_name',    'value' => '',  'label' => 'Community Name',    'group' => 'community'],
            ...
            // ── Locale ────────────────────────────────────────────────────────
            ['key' => 'app_language',   'value' => 'id',           'label' => 'Application Language', 'group' => 'locale'],
        ...
        foreach ($settings as $setting) {
            // firstOrCreate: won't overwrite values the admin has already set
