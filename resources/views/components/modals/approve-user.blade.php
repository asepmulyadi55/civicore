  ...
  <div
    ...
    <div class="px-8 py-6 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between">
      <div class="flex items-center gap-3">
        ...
        <div>
          <h2 class="text-lg font-bold text-slate-900 dark:text-white">{{ __('app.approve_user_modal_title') }}</h2>
    ...
    <form id="form-approve-user" method="POST" action="" class="p-8 space-y-5">
      ...
      <div class="rounded-xl border border-slate-200 dark:border-slate-700 overflow-hidden">
        <div class="px-4 py-3 bg-slate-50 dark:bg-slate-800/50 border-b border-slate-200 dark:border-slate-700">
          ...
          <p class="text-[11px] text-slate-400 mt-0.5">{{ __('app.household_assignment_desc') }}</p>
        </div>
        <div class="p-4 space-y-4">
          ...
          <div id="approve-resident-badge-notfound"
            ...
            {{ __('app.no_resident_record_long') }}
          </div>
