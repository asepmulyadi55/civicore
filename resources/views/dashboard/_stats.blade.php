{{-- Dashboard Stats Cards (uses x-ui.stat-card component) --}}
<section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">

  <x-ui.stat-card icon="account_balance_wallet" icon-bg="bg-primary/10" icon-text="text-primary"
    label="Total Collections" value="$42,500.00" badge="12.5%" badge-style="emerald" />
