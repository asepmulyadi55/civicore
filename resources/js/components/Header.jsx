...
export default function Header({ isDark = false, toggleDark }) {
  ...
  return (
    <div className={`fixed z-50 transition-all duration-400 ease-[cubic-bezier(0.4,0,0.2,1)] ${
      scrolled ? 'top-0 inset-x-0' : 'top-4 inset-x-4 md:inset-x-8 max-w-7xl mx-auto'
    }`}>
      <nav
      ...
      >
        ...
        <a
          ...
          style={{ color: logoColor, fontFamily: "'Plus Jakarta Sans', sans-serif", transition: 'color 0.35s ease' }}
        >
          Dwipapuri.
        </a>
