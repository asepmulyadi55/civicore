  ...
  return (
    <section id="events" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pb-20 -mt-12">
      <div className="bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col lg:flex-row">
        {/* Video Placeholder */}
        <div className="lg:w-2/3 relative flex items-center justify-center aspect-video lg:aspect-auto min-h-[340px]"
          style={{ background: '#1A237E' }}>
          <span className="absolute top-6 left-6 inline-flex items-center px-3 py-1 rounded-full text-xs font-bold tracking-widest uppercase text-white animate-pulse"
          ...
          <div className="text-center relative z-10">
            <button className="group">
              <div className="w-20 h-20 rounded-full bg-white/20 flex items-center justify-center mx-auto hover:bg-white/30 transition-all duration-300 hover:scale-110">
        ...
        <div className="lg:w-1/3 p-8 md:p-12 flex flex-col justify-center">
          ...
          <p className="text-slate-600 mb-8 leading-relaxed">
            Join us for the most anticipated event of the year! Live music, local food stalls, and community activities for all ages.
          </p>
